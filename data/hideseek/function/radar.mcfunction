...
execute as @s[scores={radar=2}] run title @s actionbar {"text":"❄ Freezing ❄","color":"aqua"}
execute as @s[scores={radar=3}] run title @s actionbar {"text":"💧 Cold 💧","color":"blue"}
execute as @s[scores={radar=4}] run title @s actionbar {"text":"🌴 Temperate 🌴","color":"yellow"}
execute as @s[scores={radar=5}] run title @s actionbar {"text":"🌵 Warm 🌵","color":"gold"}
execute as @s[scores={radar=6}] run title @s actionbar {"text":"🔥 Hot!!! 🔥","color":"red"}
execute at @s[scores={radar=6}] anchored eyes run particle flame ^ ^ ^1 0.3 1 0.3 0 10