...
execute unless score end End matches 1.. unless score pavlopetri Pavlopetri matches 1 unless score antinazgard Antinazgard matches 1 unless score passtwin Passtwin matches 1 run give @a[team=1] snowball[custom_model_data=1,item_name='{"text":"Budget Ender Pearl","italic":false,"color":"red"}'] 6
