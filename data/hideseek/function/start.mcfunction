...
execute unless score darkpeak DarkPeak matches 1 unless score pavlopetri Pavlopetri matches 1 unless score antinazgard Antinazgard matches 1 unless score antiend Antiend matches 1 unless score hailstorm Hailstorm matches 1 run effect give @a[team=2] minecraft:resistance infinite 255 true
...
execute unless score pavlopetri Pavlopetri matches 1 unless score hindenburg Hindenburg matches 1 run give @a[team=1] crossbow[max_damage=1,custom_name='{"color":"gold","italic":false,"text":"Legalos\' Shot"}',damage=1,enchantments={levels:{"minecraft:quick_charge":5}},charged_projectiles=[{id:"minecraft:spectral_arrow",count:1,components:{"minecraft:intangible_projectile":{}}}]] 1
