...
kill @e[gamemode=!spectator,gamemode=!creative,x=199,y=80,z=2129,dx=550,dy=96,dz=550]
...
execute unless score pavlopetri Pavlopetri matches 1 run item replace entity @a[team=2] hotbar.8 with chorus_fruit[enchantment_glint_override=true]
