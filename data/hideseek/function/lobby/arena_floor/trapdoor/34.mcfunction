execute as @a[tag=admin,limit=1] in hideseek:lobby positioned 17 165 73 run place template hideseek:arena_floor_trapdoor_34
schedule function hideseek:lobby/arena_floor/trapdoor/finish 5s
...
execute in hideseek:lobby positioned 17 167 89 run playsound minecraft:block.copper_trapdoor.close master @a ~ ~ ~ 100 2
