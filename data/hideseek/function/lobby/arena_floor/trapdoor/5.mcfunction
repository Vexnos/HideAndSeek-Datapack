execute as @a[tag=admin,limit=1] in hideseek:lobby positioned -12 165 73 run place template hideseek:arena_floor_trapdoor_5
schedule function hideseek:lobby/arena_floor/trapdoor/6 3t
