execute as @a[tag=admin,limit=1] in hideseek:lobby positioned 12 165 73 run place template hideseek:arena_floor_trapdoor_29
schedule function hideseek:lobby/arena_floor/trapdoor/30 3t
...
execute in hideseek:lobby positioned 12 167 89 run playsound minecraft:block.copper_trapdoor.close master @a ~ ~ ~ 100 2