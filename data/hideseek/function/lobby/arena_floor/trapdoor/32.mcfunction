execute as @a[tag=admin,limit=1] in hideseek:lobby positioned 15 165 73 run place template hideseek:arena_floor_trapdoor_32
schedule function hideseek:lobby/arena_floor/trapdoor/33 3t
...
execute in hideseek:lobby positioned 15 167 89 run playsound minecraft:block.copper_trapdoor.close master @a ~ ~ ~ 100 2