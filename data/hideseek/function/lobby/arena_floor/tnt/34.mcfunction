execute as @a[tag=admin,limit=1] in hideseek:lobby positioned 17 165 73 run place template hideseek:arena_floor_tnt_34
schedule function hideseek:lobby/arena_floor/tnt/finish 5s
