execute as @a[tag=admin,limit=1] in hideseek:lobby positioned -15 165 73 run place template hideseek:arena_floor_tnt_2
schedule function hideseek:lobby/arena_floor/tnt/3 3t
