execute as @a[tag=admin,limit=1] in hideseek:lobby positioned -12 165 73 run place template hideseek:arena_floor_tnt_5
schedule function hideseek:lobby/arena_floor/tnt/6 3t
