execute as @a[tag=admin,limit=1] in hideseek:lobby positioned -15 165 73 run place template hideseek:arena_floor_copper_2
schedule function hideseek:lobby/arena_floor/copper/3 3t
