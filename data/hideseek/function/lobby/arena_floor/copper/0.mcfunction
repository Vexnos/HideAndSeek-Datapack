execute as @a[tag=admin,limit=1] in hideseek:lobby positioned -17 165 73 run place template hideseek:arena_floor_copper_0
schedule function hideseek:lobby/arena_floor/copper/1 3t
