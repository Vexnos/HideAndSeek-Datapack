execute as @a[tag=admin,limit=1] in hideseek:lobby positioned 14 165 73 run place template hideseek:arena_floor_lava_31
schedule function hideseek:lobby/arena_floor/lava/32 5t
