execute as @a[tag=admin,limit=1] in hideseek:lobby positioned -16 165 73 run place template hideseek:arena_floor_lava_1
schedule function hideseek:lobby/arena_floor/lava/2 3t
