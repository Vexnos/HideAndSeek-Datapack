# Invisible Fox
summon fox ~ ~1 ~ {active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:true},{id:"resistance",amplifier:127,duration:-1}],attributes:[{id:"movement_speed",modifiers:[{amount:0.2,id:"movement_speed",operation:add_value}]}],Tags:["Fox","NoKill"],equipment:{chest:{id:"netherite_chestplate",count:1,components:{enchantments:{thorns:255},unbreakable:{}}}}}

# Ryland Grace Reference
summon fox ~ ~ ~ {Type:"snow",CustomName:{text:"Grace"},attributes:[{id:"minecraft:max_health",modifiers:[{id:"max_health",amount:1024,operation:add_value}]}],Health:1024.0f,Invulnerable:1b,equipment:{mainhand:{id:"minecraft:nether_star",count:1}},drop_chances:{mainhand:0.000},CanPickUpLoot:false,Tags:["Grace","NoKill"]}

# Gareth
summon panda ~ ~ ~ {Invulnerable:1b,CustomName:"Gareth",Tags:["Gareth","NoKill"],attributes:[{id:"max_health",modifiers:[{amount:1024,id:"max_health",operation:add_value}]}],Health:1024.0f}
...
# Dr Trayaurus
summon villager ~ ~ ~ {CustomName:{text:"Dr Trayaurus"},VillagerData:{profession:"librarian",level:5,type:"plains"},Invulnerable:1b,Tags:["Trayaurus","NoKill"]}
