...
item replace entity @s armor.feet with netherite_boots[enchantments={protection:4,feather_falling:4,unbreaking:3,soul_speed:3,depth_strider:3}]
give @s netherite_sword[enchantments={sharpness:5,unbreaking:3,looting:3,sweeping_edge:3,fire_aspect:2,knockback:2}]
give @s netherite_axe[enchantments={efficiency:5,sharpness:5,unbreaking:3,silk_touch:1}]
give @s bow[enchantments={power:5,unbreaking:3,punch:2,flame:1}]
item replace entity @s inventory.0 with spectral_arrow 64
item replace entity @s inventory.1 with spectral_arrow 64
give @s netherite_spear[enchantments={sharpness:5,lunge:3,unbreaking:3,knockback:2}]
give @s wind_charge 64
give @s mace[enchantments={breach:4,density:5,unbreaking:3,wind_burst:1}]
item replace entity @s weapon.offhand with shield[enchantments={unbreaking:3}]
