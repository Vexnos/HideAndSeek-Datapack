...
give @s netherite_sword[enchantments={sharpness:5,unbreaking:3,looting:3,sweeping_edge:3,knockback:2}]
give @s netherite_axe[enchantments={efficiency:5,sharpness:5,unbreaking:3,silk_touch:1}]
give @s bow[enchantments={power:5,unbreaking:3,punch:2}]
