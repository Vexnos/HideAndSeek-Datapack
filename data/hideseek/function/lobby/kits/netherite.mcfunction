...
give @s netherite_sword[enchantments={sharpness:5,unbreaking:3,looting:3,sweeping_edge:3,knockback:2,mending:1}]
give @s netherite_axe[enchantments={efficiency:5,sharpness:5,unbreaking:3,silk_touch:1,mending:1}]
give @s bow[enchantments={power:5,unbreaking:3,punch:2,mending:1}]
item replace entity @s inventory.0 with spectral_arrow 64
item replace entity @s inventory.1 with spectral_arrow 64
give @s netherite_spear[enchantments={sharpness:5,lunge:3,unbreaking:3,knockback:2,mending:1}]
