...
give @s iron_sword[enchantments={sharpness:5,unbreaking:3,looting:3,sweeping_edge:3,knockback:2,mending:1}]
give @s iron_axe[enchantments={efficiency:5,sharpness:5,unbreaking:3,silk_touch:1,mending:1}]
give @s bow[enchantments={power:3,unbreaking:3,punch:2,mending:1}]
