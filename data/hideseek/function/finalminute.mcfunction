...
give @a[team=1,gamemode=adventure] stone_sword[unbreakable={},custom_name='{"text":"Seeker\'s Bane","color":"yellow","italic":false}',enchantments={levels:{fire_aspect:2,sharpness:3}}]
