...
execute if score glowing settings matches 1.. unless score hindenburg map matches 1 at @a[team=1,tag=!out] run effect give @a[team=2,distance=..10] glowing 5 0 false
