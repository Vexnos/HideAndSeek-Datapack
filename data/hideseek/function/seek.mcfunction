...
execute unless score pavlopetri Pavlopetri matches 1 unless score hindenburg Hindenburg matches 1 run item replace entity @a[team=2] hotbar.8 with chorus_fruit[max_stack_size=99,food={nutrition:0,saturation:0,can_always_eat:true,eat_seconds:0.05}] 99
