...
give @a[team=2] heavy_core[custom_name={"text":"Back to Spawn","color":"red","italic":false},consumable={consume_seconds:999999},enchantment_glint_override=true]
...
execute if score hoa HOA matches 1.. run give @a[team=2] trident[enchantments={riptide:4},unbreakable={}]
execute if score end End matches 1.. run give @a[team=2] crossbow[unbreakable={},enchantments={piercing:5,multishot:1,quick_charge:5},item_name={"text":"SPANKR","color":"red","bold":true,"italic":false}]
...
execute if score antinazgard Antinazgard matches 1.. run give @a[team=2] crossbow[unbreakable={},enchantments={piercing:5,multishot:1,quick_charge:5},item_name={"text":"SPANKR","color":"red","bold":true,"italic":false}]
execute if score antinazgard Antinazgard matches 1.. run execute as @a[team=1] run give @a[team=2] firework_rocket[fireworks={flight_duration:3,explosions:[{shape:"large_ball",colors:[16761600]},{shape:"large_ball",colors:[16747528]},{shape:"burst",colors:[16770688]},{shape:"large_ball",colors:[16766251]},{shape:"burst",colors:[16768786]},{shape:"small_ball",colors:[16749622]},{shape:"small_ball",colors:[16763968]},{shape:"star",colors:[16764723]},{shape:"large_ball",colors:[16755717]}]}] 96
execute if score passtwin Passtwin matches 1.. run give @a[team=2] crossbow[unbreakable={},enchantments={piercing:5,multishot:1,quick_charge:5},item_name={"text":"SPANKR","color":"red","bold":true,"italic":false}]
execute if score passtwin Passtwin matches 1.. run execute as @a[team=1] run give @a[team=2] firework_rocket[fireworks={flight_duration:3,explosions:[{shape:"large_ball",colors:[16761600]},{shape:"large_ball",colors:[16747528]},{shape:"burst",colors:[16770688]},{shape:"large_ball",colors:[16766251]},{shape:"burst",colors:[16768786]},{shape:"small_ball",colors:[16749622]},{shape:"small_ball",colors:[16763968]},{shape:"star",colors:[16764723]},{shape:"large_ball",colors:[16755717]}]}] 96
execute if score pavlopetri Pavlopetri matches 1 run give @a[team=2] trident[unbreakable={},enchantments={riptide:3,impaling:1},custom_name={"text":"Booster","italic":false}]
...
execute if score venator Venator matches 1.. run give @a[team=2] crossbow[unbreakable={},enchantments={piercing:5,multishot:1,quick_charge:5},item_name={"text":"SPANKR","color":"red","bold":true,"italic":false}]
...
give @a[team=1] amethyst_shard[enchantment_glint_override=true,max_stack_size=3,consumable={animation:spear,consume_seconds:0.05,has_consume_particles:false,sound:"minecraft:entity.enderman.teleport"}] 3
