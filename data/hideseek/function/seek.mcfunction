...
item replace entity @a[team=2] hotbar.5 with heavy_core[custom_name={"text":"Back to Spawn","color":"red","italic":false},consumable={consume_seconds:999999},enchantment_glint_override=true]
