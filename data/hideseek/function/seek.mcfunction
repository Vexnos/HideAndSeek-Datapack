...
execute unless score end End matches 1.. unless score hoa HOA matches 1.. unless score ataraxia Ataraxia matches 1.. unless score antinazgard Antinazgard matches 1 unless score pavlopetri Pavlopetri matches 1 unless score passtwin Passtwin matches 1 run item replace entity @a[team=2] hotbar.3 with tripwire_hook[consumable={consume_seconds:1000001},custom_name={"text":"Dismount Grappling Hook","italic":false,"color":"blue"}]
...
item replace entity @a[team=2] hotbar.5 with heavy_core[custom_name={"text":"Back to Spawn","color":"red","italic":false},consumable={consume_seconds:0.05},max_stack_size=2,enchantment_glint_override=true]
