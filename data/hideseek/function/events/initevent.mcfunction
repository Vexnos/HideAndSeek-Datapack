...
execute unless score ataraxia Ataraxia matches 1 unless score hoa HOA matches 1 unless score newworld NewWorld matches 1 unless score #minorEvent minorEvent matches 9.. run schedule function hideseek:events/initevent 60s
execute if score ataraxia Ataraxia matches 1 unless score #minorEvent minorEvent matches 5.. run schedule function hideseek:events/initevent 60s
