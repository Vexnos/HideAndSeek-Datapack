...
execute if score cathedral map matches 1 unless score #majorEvent majorEvent matches 4.. run schedule function hideseek:events/initmevent 150s
execute if score atlantide map matches 1 unless score #majorEvent majorEvent matches 4.. run schedule function hideseek:events/initmevent 150s
