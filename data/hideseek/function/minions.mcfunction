...
execute unless score end End matches 1.. unless score pavlopetri Pavlopetri matches 1 unless score passtwin Passtwin matches 1 at @a as @e[type=experience_orb,distance=..5] at @s run summon bogged ~ ~ ~ {Team:"2",Health:30f,CustomName:{"bold":true,"color":"blue","italic":false,"text":"Gruntling"},equipment:{mainhand:{id:"minecraft:bow",count:1,components:{"minecraft:unbreakable":{},"minecraft:enchantments":{"minecraft:power":5}}},chest:{id:"minecraft:iron_chestplate",count:1,components:{"minecraft:enchantment_glint_override":true,"minecraft:trim":{material:"minecraft:netherite",pattern:"minecraft:silence"}}},head:{id:"minecraft:iron_helmet",count:1,components:{"minecraft:enchantment_glint_override":true,"minecraft:trim":{material:"minecraft:netherite",pattern:"minecraft:silence"}}}},drop_chances:{head:0.000,chest:0.000,mainhand:0.000},attributes:[{id:"minecraft:max_health",base:30},{id:"minecraft:movement_speed",base:0.8},{id:"minecraft:movement_efficiency",base:1}]}
...
execute if score pavlopetri Pavlopetri matches 1.. as @e[type=experience_orb,nbt={OnGround:1b}] at @s run summon drowned ~ ~ ~ {CustomName:{"text":"Drownedling","color":"blue"},Team:"2",Tags:["seekerguardian"],equipment:{mainhand:{id:"minecraft:trident",count:1,components:{unbreakable:{},enchantments:{impaling:3,channeling:1}}}}}
execute if score pavlopetri Pavlopetri matches 1.. at @a as @e[type=experience_orb,distance=..5] at @s run summon drowned ~ ~ ~ {CustomName:{"text":"Drownedling","color":"blue"},Team:"2",Tags:["seekerguardian"],equipment:{mainhand:{id:"minecraft:trident",count:1,components:{unbreakable:{},enchantments:{impaling:3,channeling:1}}}}}
