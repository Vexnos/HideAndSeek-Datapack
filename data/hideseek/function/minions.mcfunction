# Generic Maps: Bogged
execute unless score end End matches 1.. unless score pavlopetri Pavlopetri matches 1 unless score passtwin Passtwin matches 1 as @e[type=experience_orb,nbt={OnGround:1b}] at @s run summon bogged ~ ~ ~ {Team:"2",Health:30f,CustomName:'{"bold":true,"color":"blue","italic":false,"text":"Gruntling"}',HandItems:[{id:"minecraft:bow",count:1,components:{"minecraft:unbreakable":{},"minecraft:enchantments":{levels:{"minecraft:flame":1,"minecraft:power":5}}}},{}],HandDropChances:[0.000F,0.085F],ArmorItems:[{},{},{id:"minecraft:iron_chestplate",count:1,components:{"minecraft:enchantment_glint_override":true,"minecraft:trim":{material:"minecraft:netherite",pattern:"minecraft:silence"}}},{id:"minecraft:iron_helmet",count:1,components:{"minecraft:enchantment_glint_override":true,"minecraft:trim":{material:"minecraft:netherite",pattern:"minecraft:silence"}}}],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],attributes:[{id:"minecraft:generic.max_health",base:30},{id:"minecraft:generic.movement_speed",base:0.8},{id:"minecraft:generic.movement_efficiency",base:1}]}
