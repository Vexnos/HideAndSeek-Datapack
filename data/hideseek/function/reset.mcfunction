...
execute unless score #test playTesting matches 1 if score trackStats settings matches 1 run execute as @a[team=2] if score hiders hiding <= out out run scoreboard players add @s winsAsSeeker 1
