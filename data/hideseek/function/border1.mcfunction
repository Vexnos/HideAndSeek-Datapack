...
execute if score paleora Paleora matches 1.. in hideseek:lobby run worldborder set 100 30s
...
execute if score atlantide Atlantide matches 1.. in hideseek:atlantide run worldborder set 350 45s
