...
execute unless score end End matches 1.. run give @a[team=1] egg{display:{Name:'{"text":"Make the Seeker go away","color":"blue","italic":"false"}'}} 1
execute unless score end End matches 1.. run give @a[team=1] snowball{CustomModelData:1,display:{Name:'{"text":"Budget Ender Pearl","italic":"false","color":"red"}'}} 5
