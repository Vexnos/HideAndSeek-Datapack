...
execute if score #randInt randInt matches 6..10 run effect give @a speed 10 2 true
execute if score #randInt randInt matches 11..15 run effect give @a poison 10 3 true
execute if score #randInt randInt matches 16..20 run effect give @a slowness 10 3 true
execute if score #randInt randInt matches 21..24 run effect give @a[team=1] resistance 10 5 true
execute if score #randInt randInt matches 25..29 run effect give @a darkness 10 5 true
